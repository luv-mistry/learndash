...
function learndash_reports_get_activity( $query_args = array(), $current_user_id = 0 ) {
	...
	$query_args['user_ids']        = LDLMS_DB::escape_numeric_array( $query_args['user_ids'] );
	$query_args['post_ids']        = LDLMS_DB::escape_numeric_array( $query_args['post_ids'] );
	$query_args['group_ids']       = LDLMS_DB::escape_numeric_array( $query_args['group_ids'] );
	$query_args['course_ids']      = LDLMS_DB::escape_numeric_array( $query_args['course_ids'] );
	$query_args['post_status']     = LDLMS_DB::escape_string_array( $query_args['post_status'] );
	$query_args['post_types']      = LDLMS_DB::escape_string_array( $query_args['post_types'] );
	$query_args['activity_status'] = LDLMS_DB::escape_string_array( $query_args['activity_status'] );
	$query_args['activity_types']  = LDLMS_DB::escape_string_array( $query_args['activity_types'] );
