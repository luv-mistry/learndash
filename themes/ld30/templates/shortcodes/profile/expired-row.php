<?php
/**
 * LearnDash LD30 Displays a user's profile course expired row.
 *
 * @since 3.0.0
 *
...
$course_link = get_post_meta($course_id, '_sfwd-courses', true)['sfwd-courses_custom_button_url'];
...
<div class="<?php echo esc_attr( $course_class ); ?>" id="<?php echo esc_attr( 'ld-course-list-item-' . $course_id ); ?>">
	<div class="ld-item-list-item-preview">
		...
		<div class="ld-item-details">
			...
			<div class="expired-background">Expired</div>
